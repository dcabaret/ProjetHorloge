 ...
 * @param _couleurTexte : Couleur du texte
 * @param _couleurTexte : Couleur du fond
 */
Cadran::Cadran(const int _posX, const int _posY, const int _hauteur, const int _largeur, const int _couleurTexte, const int _couleurFond):
    posX(_posX+1),
    posY(_posY+1),
    hauteur(_hauteur),
    largeur(_largeur),
 ...
 * @details : Efface ce qui est affiché dans le cadran
 */
void Cadran::Effacer()
{
